...
export const createPost = async (req, res) => {
  ...
  const message = `
        <h3>Hello ${name}</h3>
        <p>Hey, Congrulations! you are selected for the RFQ : ${rfq_name}. Please go and register yourself  at "http://54.37.6.229:3000/logS321yweQHWGEJHignu4234Tok34234ensdddsafd232344sasda4234243sdasdasaD131sasdkbehj12h124hj12f3g4f3hjvbpVendorin312kjnv32hkendore" </p>
        <p>Regards...</p>
        <p>Muhammad Jibran</p>
    `;
